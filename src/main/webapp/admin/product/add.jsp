			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td align="center" class="ta_01" bgColor="#ffffff">
						<input type="text" name="product.pname" value="" class="bg"/>
					</td>
				</tr>
				<tr>
					<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<tr>
					...
					<td align="center" class="ta_01" bgColor="#ffffff">
						<input type="text" name="product.market_price" value="" class="bg"/>
					</td>
				</tr>
				<tr>
					<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
					...
					<td align="center" class="ta_01" bgColor="#ffffff">
						<input type="text" name="product.shop_price" value="" class="bg"/>
					</td>
				</tr>
				<tr>
					<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<tr>
					...
					<td align="center" class="ta_01" bgColor="#ffffff">
						<textarea rows="5" cols="20" name="product.pdesc" ></textarea>
					</td>
				</tr>
