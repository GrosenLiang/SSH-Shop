...
<%@ page import="com.grosen.sshShopping.order.vo.Order" %>
<%@ page import="com.grosen.sshShopping.utils.PageBean" %>
...
<div class="container header">
    <div class="span5">
        <div class="logo">
            <a href="index.action">
                <img src="./image/r___________renleipic_01/logo.jpg" alt="果森商城"/>
            </a>
        </div>
    </div>
    <div class="span9">
...
<div class="container cart">
    ...
    <div class="span24">
        ...
        <table>
            ...
            <tr>
                <th colspan="5">订单编号：<s:property value="#list.oid"/>&nbsp;&nbsp;&nbsp;&nbsp;订单金额：<s:property value="list.total"/>&nbsp;&nbsp;&nbsp;
                    <s:if test="#list.state == 1">
                        <a href="order_findByOid.action?oid=<s:property value="#list.oid"/> "><font color="red">未付款</font></a>
                    </s:if>
                    ...
                    <div class="pagination">
                        <span>第<s:property value="page" />/<s:property value="pageBean.totalPage" />页</span>
                            <s:if test="pageBean.page != 1">
                                ...
                                <a href="order_findByUid.action?page=<s:property value="pageBean.page-1" />" class="previousPage">&nbsp;</a>
                            </s:if>
                            ...
                            %>
                            <a href="order_findByUid.action?page=<%=i%>"><%=i%></a>
                            <%
                                }
                            %>

                            <s:if test="pageBean.page != pageBean.totalPage">
                                <a class="nextPage" href="order_findByUid.action?page=<s:property value="pageBean.page + 1"/>">&nbsp;</a>
                                <a class="lastPage" href="order_findByUid.action?page=<s:property value="pageBean.totalPage"/>">&nbsp;</a>
                            </s:if>
                    </div>
                </td>
            </tr>
