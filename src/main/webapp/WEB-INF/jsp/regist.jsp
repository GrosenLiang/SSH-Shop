...
<head>
    ...
    <script>
        //简单前台js校验
          function checkForm() {
             ...
             if (password == null || password == '') {
              ...
              var phonefilter  = /^(13[0-9]|14[0-9]|15[0-9]|18[0-9])\d{8}$/i
              if (phone == null || phone == '') {
                  alert("电话不能为空!");
                  return false;
        ...
        /*function checkUsername() {
            ...
            //3.打开连接
            xhr.open("GET","{pageContext.request.contextPath}/user_checkUserName.action?username="+username+"&amp;time="+new Date().getTime(),true);
            //4.发送
            xhr.send(null);
        }
        ...
        function change() {
            ...
            img1.src = "checkImg.action?time="+new Date().getTime();
        }
    </script>
</head>
<body>
                ...
                <form id="registerForm" action="user_regist.action" method="post" novalidate="novalidate" onsubmit="return checkForm()">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="name" class="text" id="name" maxlength="200">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="fieldSet">
                                    <input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" ><img id="checkImg" class="captchaImage" src="${pageContext.request.contextPath}/checkImg.action" onclick="change()" title="点击更换验证码"><span style="color: red"><s:actionerror /></span>
                                </span>
                            </td>
                        </tr>
                        <tr>
