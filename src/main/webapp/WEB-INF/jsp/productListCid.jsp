            ...
            <div class="pagination">
                ...
                <s:if test="cid != null">
                    <s:if test="pageBean.page != 1">
                        ...
                        <a href="product_findByCid.action?cid=<s:property value="cid" />&page=<s:property value="pageBean.page-1" />" class="previousPage">&nbsp;</a>
                    </s:if>
                    ...
                    %>
                    <a href="product_findByCid.action?cid=<s:property value="cid" />&page=<%=i%>"><%=i%></a>
                    <%
                        }
                    %>
